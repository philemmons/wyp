...
<!--  QUICK LINKS STRIP  -->
<aside aria-labelledby="error-403-helpful-links-heading">
    <div class="quicklinks-section wyp-section-alt">
        <div class="container">

            <h2 class="quicklinks-title text-center" id="error-403-helpful-links-heading">Where would you like to go?</h2>
