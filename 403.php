...
<section class="error-hero">
  ...
  <div class="container page-hero-z">
    <div class="error-card">
      ...
      <p class="error-tagline">This page is protected.</p>
      <p class="error-body">
        You do not have access to this page right now.
        Use one of the links below to continue browsing.
      </p>
...
<section class="page-section-sm bg-cream">
  <div class="container">
    <details class="simple-summary">
      ...
      <p>
        This page is blocked. Pick a link below to open another page.
      </p>
    </details>
  </div>
</section>
